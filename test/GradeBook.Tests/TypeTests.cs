...
namespace GradeBook.Tests
{
    ...
    public class TypeTests
    {
        ...
        private void GetBookSetName(ref InMemeryBook book, string name)
        {
            book = new InMemeryBook(name);
        }
        ...
        private void GetBookSetName(InMemeryBook book, string name)
        {
            book = new InMemeryBook(name);
        }
        ...
        private void SetName(InMemeryBook book, string name)
        {
            book.Name = name;
        }
        ...
        InMemeryBook GetBook(string name)
        {
            return new InMemeryBook(name);
        }
    }
}
